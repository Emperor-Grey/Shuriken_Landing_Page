...
export const Navigation = () => {
    ...
    const navItems = ['Features', 'Solutions', 'Pricing', 'Team', 'About', 'Contact'];
    ...
    return (
        <motion.nav className="fixed top-4 left-1/2 -translate-x-1/2 w-[90%] max-w-7xl z-50">
                    ...
                    <div className="flex items-center justify-between h-16">
                        <motion.div className="flex-1 flex items-center justify-start">
                            <div className="relative w-14 h-14">
                                ...
                                >
                                    <img className='w-full h-full' src={Logo} alt="Shuriken Logo" />
                                </motion.div>
                            </div>
                            <div className="ml-2">
            ...
            {/* Mobile Menu */}
            <motion.div
                className={`md:hidden absolute top-full left-0 right-0 mt-2 p-4 bg-dark-900/95 backdrop-blur-xl rounded-2xl border border-dark-800/50 ${isMobileMenuOpen ? 'block' : 'hidden'}`}
