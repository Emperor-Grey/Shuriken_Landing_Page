                    ...
                    {[
                        {
                            ...
                            description: "Get personalized course recommendations from Udemy and LinkedIn Learning based on your interests and skill level",
                            icon: <Compass className="w-8 h-8 text-primary-500" />
                        },
                        {
                            title: "Learn with AI Assistant",
                            description: "Find the perfect YouTube tutorials and resources curated by AI to match your learning style",
                            icon: <Brain className="w-8 h-8 text-primary-500" />
                        },
                        {
                            title: "Test Your Knowledge",
                            description: "Challenge yourself with AI-generated quizzes and get instant feedback on your progress",
                            icon: <GraduationCap className="w-8 h-8 text-primary-500" />
                        },
                        {
                            title: "Career Boost",
                            description: "Build ATS-friendly resumes and get AI-powered tips to improve your job applications",
